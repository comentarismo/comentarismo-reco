...
(function() {
  var Hapi, RECO, REDIS_HOST, REDIS_PASS, REDIS_PORT, RETHINKDB_BUFFER, RETHINKDB_DB, RETHINKDB_HOST, RETHINKDB_MAX, RETHINKDB_PORT, RETHINKDB_TIMEOUT, RethinkDBESM, ServerRecommendationEngine, _, bb, r, reco, ret_esm;
  ...
  ServerRecommendationEngine = (function() {
    ...
    ServerRecommendationEngine.prototype.add_server_routes = function() {
      return this.load_server_plugin('./api', {
        reco: this._reco
      });
    };
